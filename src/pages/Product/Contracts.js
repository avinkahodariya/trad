        ...
        <section id="contract-section">
                <div className="container flex flex-wrap  px-20 py-10 mx-auto">
                    <div className='grid grid-cols-3 '>
                        ...
                        <div className='center-box relative justify-center items-center flex  mb-20 rounded-full w-200 h-200 mx-auto  mt-20 bg-gradient-to-r p-[1.5px] from-[#0FCE7E] via-[#0080F6] to-[#9333EA]' >
                            ...
                            <div className=' flex  justify-between items-center text-center h-full bg-white text-white rounded-full p-4 w-full h-full z-10' >
