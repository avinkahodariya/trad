...
function Table() {
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    {/* <p className=" leading-relaxed  text-left">Banh mi cornhole echo park skateboard authentic crucifix neutra tilde lyft biodiesel artisan direct trade mumblecore 3 wolf moon twee</p> */}
    </div>
    <div className=" w-full mx-auto overflow-auto">
      <table className="table-auto w-full h-20 whitespace-no-wrap">
        ...
        <tbody>
          <tr className='mt-2'>
            ...
            <h1 className="sm:text-xl text-xl font-medium title-font mb-2 text-[#0A2A4A]">TRADEPLUS (Windows Version)</h1>
      <p className=" leading-relaxed  text-sm text-left text-[#808D9A] font-normal">Back office software for Equity and dervatives segments for brokers on various exchanges.</p>
            </td>
            <td className="px-4 py-3 title-font font-normal text-[#808d9a] text-sm bg-[#ffffff] text-center">Daily contracts, bills, Ledger, Account Confirmations</td>
      ...
      <p className=" leading-relaxed  text-[1rem] text-left text-[#808D9A] font-normal">Back office software for DP on CDSL</p>
            ...
            <td className="px-4 py-3 title-font font-normal text-[#808d9a] text-sm bg-[#ffffff] text-center">Holding  & Transaction Statements, Bills, Ledgers</td>
