...
function Table() {
  ...
  <div className="flex flex-col text-center w-full mb-10 px-5 ">
      <p className=" title-font font-normal text-[#808d9a] text-[1rem] bg-[#ffffff] text-left">The above back-office packages will have option to digitally sign the documents before they are e-mailed. Client can have various persons signing the document and when there are multiple IDs installed on same machine, it shall ask for the person who is to sign the document and his associated password.</p>
    </div>
</section>
    </>
  )
