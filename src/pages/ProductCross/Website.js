  ...
  return (
    ...
    <section className='brancher-sections  branch-timeline bg-[#ffffff] '>
        <div className='   px-12 py-12 '  >
            ...
            <h2 className='title text-lg lg:text-2xl font-bold sm:text-3xl md:text-3xl pt-5  text-[#0A2A4A] relative text-center pb-10 '>Web Site Connectivity (Optional)</h2>
